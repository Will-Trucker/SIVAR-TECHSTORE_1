...
<br><br><br><br><br><br><br><br>
    ...
    <div class="description">
      ...
      <div class="PrecioD">
        ...
        <a href="#" class="agregar-carrito" data-id="1"><p>Agregar Al Carrito</p></a>
      </div>
...
<div class="container">
  <div class="img_container">
      <img src="{{asset('img/descarga.jpg')}}" alt="" class="main_img">
  </div>

  <div class="thumbnail_container">
      <img src="{{asset('img/descarga.jpg')}}" alt="" class="thumbnail active">
      <img src="{{asset('img/ml240l-v2-rgb-white-380x380-1-hover.png')}}" alt="" class="thumbnail">
      <img src="{{asset('img/images.jpg')}}" alt="" class="thumbnail">
