...
<br><br><br><br><br><br><br><br>
     <div class="page-title-wrapper" aria-label="Page title">
      <div class="container1">
          ...
          <h1 class="page-title">Cooler Master MasterLiquid ML240R RGB</h1><span class="d-block mt-2 text-muted"></span>
      </div>
  </div>
    <div class="description">
      <div class="PrecioYCarro">
      <div class="PrecioD">
        <h2 class="PrecioNumero">$82.99</h2>
      </div>
...
<div class="container">
  <div class="img_container">
      <img src="{{asset('img/mouse.png')}}" alt="" class="main_img">
  </div>
