...
<head>
    ...
    <link rel="icon" type="picture" href="<?php echo e(asset('img/Icono.png'), false); ?>">
...
<body>
    ...
    <header class="header">
       <a class="logo" href="#"><img class="logotipo" src="<?php echo e(asset('img/Asset 7.webp'), false); ?>" alt="logo"></a>
        <nav>
            <ul class="nav__links">
              <li><a href="<?php echo e(route('register'), false); ?>" class="opciones bars-solid"><svg class="bars-solid"  xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 50 50" width="30px" height="40px"><path  fill=currentcolor d="M 0 7.5 L 0 12.5 L 50 12.5 L 50 7.5 Z M 0 22.5 L 0 27.5 L 50 27.5 L 50 22.5 Z M 0 37.5 L 0 42.5 L 50 42.5 L 50 37.5 Z"/></svg> Catalogo</a></li>
              <li><a href="<?php echo e(route('login'), false); ?>" class="opciones cotizar"><svg class="cotizar" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="30px" height="40px"><path fill="currentColor" d="M256 288c79.53 0 144-64.47 144-144s-64.47-144-144-144c-79.52 0-144 64.47-144 144S176.5 288 256 288zM351.1 320H160c-88.36 0-160 71.63-160 160c0 17.67 14.33 32 31.1 32H480c17.67 0 31.1-14.33 31.1-32C512 391.6 440.4 320 351.1 320z"/></svg> Iniciar Sesion</a></li>
              <li><a href="<?php echo e(route('register'), false); ?>" class="opciones carretilla"><svg class="carretilla"xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path fill="currentcolor" d="M96 0C107.5 0 117.4 8.19 119.6 19.51L121.1 32H541.8C562.1 32 578.3 52.25 572.6 72.66L518.6 264.7C514.7 278.5 502.1 288 487.8 288H170.7L179.9 336H488C501.3 336 512 346.7 512 360C512 373.3 501.3 384 488 384H159.1C148.5 384 138.6 375.8 136.4 364.5L76.14 48H24C10.75 48 0 37.25 0 24C0 10.75 10.75 0 24 0H96zM128 464C128 437.5 149.5 416 176 416C202.5 416 224 437.5 224 464C224 490.5 202.5 512 176 512C149.5 512 128 490.5 128 464zM512 464C512 490.5 490.5 512 464 512C437.5 512 416 490.5 416 464C416 437.5 437.5 416 464 416C490.5 416 512 437.5 512 464z"/></svg> Compras</a></li>
            </ul>
        </nav>
    <a class="cta" href="<?php echo e(route('register'), false); ?>">¡REGISTRATE!</a> 
    ...
    <div class="overlay" id="mobile-menu">
        ...
        <div class="overlay__content">
            <a href="<?php echo e(route('register'), false); ?>">Catalogo</a>
            <a href="<?php echo e(route('register'), false); ?>">Cotizá</a>
            <a href="<?php echo e(route('register'), false); ?>">Compras</a> 
            <a href="<?php echo e(route('acerca'), false); ?>">Nosotros</a>
            <a  href="<?php echo e(route('register'), false); ?>">¡REGISTRATE!</a> 
        </div>
    </div>
...
<div class="container">
    ...
    <div class="slide">
        <div class="content text">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus, quibusdam. Ab officia fugit accusamus optio tempora earum placeat quos sit aut magni, in voluptatem repudiandae sunt, tenetur iste, dicta molestiae.</p>
            <a href="<?php echo e(route('register'), false); ?>" class="btn">Ver Catalogo</a>
    ...
    <div class="slide">
        <div class="content text">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus, quibusdam. Ab officia fugit accusamus optio tempora earum placeat quos sit aut magni, in voluptatem repudiandae sunt, tenetur iste, dicta molestiae.</p>
            <a href="<?php echo e(route('register'), false); ?>" class="btn">Registrarme</a>
    ...
    <footer class="pie-pagina">
        <div class="grupo-1">
            ...
            <div class="box">
                ...
                <button class="boton-us"><a href="<?php echo e(route('acerca'), false); ?>">Más informacion</a></button>
            </div>
            <div class="box">
                <div class="box">
...
</html><?php /**PATH C:\xampp\htdocs\SIVAR-TECHSTORE_1\laravel-mvc\resources\views/welcome.blade.php ENDPATH**/ ?>