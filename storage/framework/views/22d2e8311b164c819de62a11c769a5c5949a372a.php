...
<head>
    ...
    <link rel="preload" type="text/css" href="<?php echo e(asset('css/all-product.css'), false); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/all-product.css'), false); ?>">
 ...
 <div class="navegacion">
    <header class="header">
       <a class="logo" href="/home" style="outline: none;">
        <img class="logotipo" src="<?php echo e(asset('img/Asset 7.webp'), false); ?>" alt="logo">
    </a>
        <nav>
            <ul class="nav__links">
...
<script src="<?php echo e(asset('js/opciones.js'), false); ?>"></script> <!-- efecto de bajar menu (no se porque solo agarra aqui)-->

 <!--Tarjetas-->
    <div class="productos">  
    <?php $__currentLoopData = $datos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 <div class="producto"><img src="/productos/<?php echo e($productos->foto, false); ?>" height="180px" width="200px" alt="tarjeta grafica"> 
     <div class="informacion">
    
        <span class="precio"> $<?php echo e($productos->precio, false); ?></span>
        <span class="descripcion"><?php echo e($productos->nombre, false); ?></span>

        <span class="precio-envio"><?php echo e($productos->categoria, false); ?></span>
    </div>
  </div>
...
<?php /**PATH C:\xampp\htdocs\SIVAR-TECHSTORE_1\laravel-mvc\resources\views/viewp.blade.php ENDPATH**/ ?>