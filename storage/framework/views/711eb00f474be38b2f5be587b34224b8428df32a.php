...
<head>
    ...
    <link rel="preload" type="text/css" href="<?php echo e(asset('css/style.css'), false); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/style.css'), false); ?>">
...
<body>
    <div class="navegacion">
        ...
        <div class="overlay" id="mobile-menu">
            ...
            <div class="overlay__content">
                ...
                <a href=""></a>
                <a href="">Compras</a> 
                <a class="cta" href="<?php echo e(route('login'), false); ?>">Iniciar Sesion</a>
            </div>
        </div>
    ...
    <br><br><br><br><br>
        ...
        <center><h1>¿Quienes somos?</h1>
                <hr style="background: red; width: 290px; height: 7px; border: none; margin-top: -25px;"></center>
        
        <div id="general">
            <br>
            <center><img src="img/Asset 4.png">      </center>
                <p class="descripcion"><b>SIVAR-TECHSTORE </b> es una empresa que nacio en ENERO del 2022 con 
                    el proposito de crear una tienda E-COMMERCE en el ambito de la tecnologia basandose 
                    en la venta de computadoras y partes usando las tecnologias de Desarrollo 
                    Web como HTML, CSS, JAVASCRIPT, PHP, etc. que se presentara como proyecto en CREAJ-2022. 
                    </p>
      
        </div>
        <h1 class="title">Integrantes:</h1>
       <center><hr style="background: red; width: 250px; height: 6px; border: none; margin-top: -30px;"></center> 
        <br>
       <div class="container">
            ...
            <div class="card">
                <img src="img/WhatsApp Image 2022-05-23 at 5.38.32 PM.jpeg">
                <h4>Diego Fernando Ruiz Valle</h4>
                <br>
                <p>Miembro y Diseñador de la Empresa</p>
            </div>
...
<?php /**PATH C:\xampp\htdocs\SIVAR-TECHSTORE_1\laravel-mvc\resources\views/about.blade.php ENDPATH**/ ?>