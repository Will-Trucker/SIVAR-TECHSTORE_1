...
<head>
    ...
    <link rel="preload" type="text/css" href="<?php echo e(asset('css/catalogo.css'), false); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/catalogo.css'), false); ?>">
...
<main>
    ...
    <div class="overlay" id="mobile-menu">
        ...
        <div class="overlay__content">
            ...
            <a href="#">Carrito</a>
            <a href="#">Compras</a> 
            <a href="<?php echo e(asset('acerca'), false); ?>">Nosotros</a>
            <a  class="cta" href="<?php echo e(route('logout'), false); ?>"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                       <?php echo e(__('Salir'), false); ?>   
                                    </a>
...
<div class="title">
<h1>CATEGORIAS</h1>
<center><hr style="background: red; width: 200px; height: 7px; border: none; margin-top: -15px;"></center>
</div>
 <div class="productos">  
    <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 <div class="producto">
  <a href="/todos/<?php echo e($categoria->nombre, false); ?>" class="a">
  <img src="/categorias/<?php echo e($categoria->imagen, false); ?>"  alt="Imagenes Cat" class="cat-img"> 
  <br>
   <span class="descripcion"><?php echo e($categoria->nombre, false); ?></span>
  </a>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SIVAR-TECHSTORE_1\laravel-mvc\resources\views/categorias.blade.php ENDPATH**/ ?>